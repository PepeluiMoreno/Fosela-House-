...
Instalación térmica integrada (aerotermia monobloc R290 + solar térmico) para vivienda de 220 m² + 4 apartamentos turísticos + piscina, en Jerez de la Frontera. Control con un único PLC Schneider Modicon M241.
...
| [M09](modulos/M09_control.md) | Control — PLC M241 | 🔶 hardware y FBs base, falta integración |
