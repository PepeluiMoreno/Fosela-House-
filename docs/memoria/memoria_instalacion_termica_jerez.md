...
- **Seguridad sanitaria del ramal interior por diseño**: el CE mantiene el agua a temperatura de seguridad de forma continua. El ramal entre V3V_APT y el CE tiene un volumen mínimo que se renueva en cada uso. En la práctica, la limpieza del apartamento previa a cada entrada de huéspedes consume agua caliente del CE, renovando el ramal de forma natural antes de que el cliente llegue. La seguridad sanitaria queda garantizada por construcción y por el protocolo habitual de limpieza, sin necesidad de ninguna acción adicional.
